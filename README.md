...
- HTML, CSS (Sass/SCSS), JavaScript (ES6+)  
- React (для динамических элементов и управления состоянием)  
- Next.js (для SSR и оптимизации SEO)  
- Telegram Web Apps SDK (для интеграции с Telegram Mini App)  
- Tailwind CSS или Material-UI (для быстрой разработки адаптивного дизайна)  
- Vercel (для деплоя)
